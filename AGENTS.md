...
- The compatibility baseline is Vercel eve 0.54.0 and the minimum supported release is
  0.52.3, using message-stream protocol version 25 and agent-info schema version 4.
