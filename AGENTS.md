...
- The compatibility baseline is Vercel eve 0.31.3, stream protocol version 20 events plus the
  0.31.0 identifier-addressed HTTP contract. The minimum supported eve release is 0.31.0;
