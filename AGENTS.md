...
- The compatibility baseline is Vercel eve 0.45.0, message-stream protocol version 23. The
  minimum supported eve release is 0.31.0; earlier servers are not supported.
