...
public static class EveProtocol
{
    ...
    /// </summary>
    public const string ReferenceEveVersion = "0.38.1";
    ...
    /// value remains <c>22</c> through eve <c>0.38.1</c>.
    /// </remarks>
    ...
    /// schema remains version <c>2</c> through eve <c>0.38.1</c>. Both versions expose the
